...
public partial class Admin_Reprt_DailyPurchaseReport : System.Web.UI.Page
{
    SqlDataReader dr;
    SqlConnection con;
    static int count = 0;
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        string sql = "select PurOrdNo from PurchaseMaster where PurOrdDate='" + dt + "'";
        ...
        if (count == 1)
        {
            string sql1 = "select * from PurchaseDetails where PurOrdNo='" + ch + "'";
